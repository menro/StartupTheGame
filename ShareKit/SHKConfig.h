...
#define SHKFacebookKey				@"199401146811668"
#define SHKFacebookSecret			@"9ef297919333ab27c5b5fc01998f47fc"
 ...
 */
#define SHKTwitterConsumerKey		@"iTFw7TB9vIDZGrXXPWapYQ"
#define SHKTwitterSecret			@"Y50Nhe4ZMhyv0aiAVqGBS43f32KvL8LDoyIaKx4V1L0"
#define SHKTwitterCallbackUrl		@"https://openspacestore.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
